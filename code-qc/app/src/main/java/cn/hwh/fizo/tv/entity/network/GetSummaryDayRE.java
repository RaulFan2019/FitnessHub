...
public class GetSummaryDayRE {
    ...
    public List<MoverBean> top10_effort_point;
    public List<MoverBean> top10_minutes;
    public List<MoverBean> top10_calorie;
    public List<MoverBean> top10_avg_effort;
    public int total_movercount;
    public int total_minutes;
    public int total_calorie;
    public int total_effort_point;
    public int total_avg_effort;
