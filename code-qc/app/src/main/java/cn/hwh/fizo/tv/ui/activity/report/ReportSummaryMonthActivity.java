...
//        Log.v(TAG, "keyCode:" + keyCode);
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case MSG_POST_ERROR:
                    Toasty.error(ReportSummaryMonthActivity.this, (String) msg.obj).show();
                    finish();
                    break;
                case MSG_POST_OK:
                    vLoading.loadFinish();
    ...
    private void postGetSummaryDayData() {
        x.task().post(new Runnable() {
            @Override
            public void run() {
                int storeId = SPDataStore.getStoreId(ReportSummaryMonthActivity.this);
                String day = TimeU.getMonthByDelay(1);
                RequestParams params = RequestParamsBuilder.buildGetSummaryMonthRP(ReportSummaryMonthActivity.this,
    ...
    private void updateSummaryView() {
        ...
        tvTitle.setText("上月报告（" + mGetSummaryDayRe.total_movercount + "人）");
