...
//        Log.v(TAG, "keyCode:" + keyCode);
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case MSG_POST_ERROR:
                    Toasty.error(ReportSummaryWeekActivity.this, (String) msg.obj).show();
                    finish();
                    break;
                case MSG_POST_OK:
                    vLoading.loadFinish();
    ...
    private void postGetSummaryDayData() {
        x.task().post(new Runnable() {
            @Override
            public void run() {
                int storeId = SPDataStore.getStoreId(ReportSummaryWeekActivity.this);
                String day = TimeU.getWeekByDelay(1);
                Log.v("postGetSummaryDayData","day:" + day);
                RequestParams params = RequestParamsBuilder.buildGetSummaryWeekRP(ReportSummaryWeekActivity.this,
    ...
    private void updateSummaryView() {
        ...
        tvTitle.setText("上周报告（" + mGetSummaryDayRe.total_movercount + "人）");
