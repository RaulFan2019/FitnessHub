...
public class MainBindRvAdapter extends RecyclerView.Adapter<MainBindRvAdapter.localHolder> {


    private int[] bgRes = new int[]{
            R.drawable.bg_main_bind_close_hub,
            R.drawable.bg_main_bind_input_ant};
    ...
    public MainBindRvAdapter(Context context, onItemClickListener listener) {
        super();
        mContext = context;
    ...
    public localHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_rv_main_bind, viewGroup, false);
