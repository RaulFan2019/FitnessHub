...
public class MainQcRvAdapter extends RecyclerView.Adapter<MainQcRvAdapter.localHolder> {


    private int[] bgRes = new int[]{
            R.drawable.bg_main_qc_sport,
...
//            "锻炼模式", "WIFI设置", "软件更新", "关于我们"
    ...
    public MainQcRvAdapter(Context context, onItemClickListener listener) {
        super();
        mContext = context;
