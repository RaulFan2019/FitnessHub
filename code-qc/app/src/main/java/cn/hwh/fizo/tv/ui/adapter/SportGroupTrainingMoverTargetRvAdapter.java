...
public class SportGroupTrainingMoverTargetRvAdapter extends RecyclerView.Adapter<SportGroupTrainingMoverTargetRvAdapter.SportMoverTargetVH> {
    ...
    public SportGroupTrainingMoverTargetRvAdapter(final Context context, final List<GroupTrainingMoverME> list, final int countState, final int page) {
        this.mData = list;
...
//        Log.v(TAG,"mCountState:" + mCountState);
    ...
    class SportMoverTargetVH extends RecyclerView.ViewHolder {
        ...
        public void bindItem(final GroupTrainingMoverME entity) {
            ...
            if (entity.currHr < entity.trainingMoverDE.targetHr) {
                llRoot.setBackgroundResource(R.drawable.bg_item_sport_target_low);
            } else if (entity.currHr < entity.trainingMoverDE.targetHrHigh) {
