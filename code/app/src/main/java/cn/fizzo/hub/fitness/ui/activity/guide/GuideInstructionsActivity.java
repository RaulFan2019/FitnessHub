...
import cn.fizzo.hub.fitness.ui.activity.main.MainMenuActivity;
...
public class GuideInstructionsActivity extends BaseActivity {
    ...
    private void updateGuideView() {
        if (mStep == 1) {
            vGuide.setBackgroundResource(R.drawable.bg_guide_instructions_1);
            tvTitle.setText(getResources().getString(R.string.guide_instruction_title_1));
            btnNext.requestFocus();
            btnPre.setVisibility(View.GONE);
        } else if (mStep == 2) {
            vGuide.setBackgroundResource(R.drawable.bg_guide_instructions_2);
            tvTitle.setText(getResources().getString(R.string.guide_instruction_title_2));
