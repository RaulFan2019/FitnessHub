...
public class CourseSelectRvAdapter extends RecyclerView.Adapter {

    private MyOpenPresenter mPresenter;


    public CourseSelectRvAdapter(MyOpenPresenter presenter) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        CourseSelectRvAdapter.ViewHolder viewHolder = new CourseSelectRvAdapter.ViewHolder(view, presenter, presenterVh);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        CourseSelectRvAdapter.ViewHolder viewHolder = (CourseSelectRvAdapter.ViewHolder) holder;
