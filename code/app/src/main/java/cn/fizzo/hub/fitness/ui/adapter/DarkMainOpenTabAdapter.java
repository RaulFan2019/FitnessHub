...
public class DarkMainOpenTabAdapter extends BaseTabTitleAdapter {

    private List<String> titleList = new ArrayList<String>();

    public DarkMainOpenTabAdapter(Context context) {
        ...
        titleList.add(context.getResources().getString(R.string.main_menu_tab_help));
    }
    ...
    private List<Integer> ids = new ArrayList<Integer>() {
        {
            ...
            add(R.id.main_menu_tab_title_help);
        }
    };
