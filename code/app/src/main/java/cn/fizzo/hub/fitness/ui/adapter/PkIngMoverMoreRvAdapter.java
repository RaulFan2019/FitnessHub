...
public class PkIngMoverMoreRvAdapter extends RecyclerView.Adapter<PkIngMoverMoreRvAdapter.LocalVH>{
    ...
    public PkIngMoverMoreRvAdapter(final Context context, final List<GroupTrainingMoverME> list,
    ...
    @Override
    public PkIngMoverMoreRvAdapter.LocalVH onCreateViewHolder(ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(mContext).inflate(R.layout.item_rv_pk_ing_mode_more, parent, false);
        return new PkIngMoverMoreRvAdapter.LocalVH(v);
    }

    @Override
    public void onBindViewHolder(PkIngMoverMoreRvAdapter.LocalVH holder, int position) {
    ...
    class LocalVH extends RecyclerView.ViewHolder {
        ...
        public void bindItem(final GroupTrainingMoverME entity) {
            ...
            if (percent < 50) {
                llRoot.setBackgroundResource(R.drawable.bg_item_pk_mover_more_percent_0);
            } else if (percent < 60) {
                llRoot.setBackgroundResource(R.drawable.bg_item_pk_mover_more_percent_50);
            } else if (percent < 70) {
                llRoot.setBackgroundResource(R.drawable.bg_item_pk_mover_more_percent_60);
            } else if (percent < 80) {
                llRoot.setBackgroundResource(R.drawable.bg_item_pk_mover_more_percent_70);
            } else if (percent < 90) {
                llRoot.setBackgroundResource(R.drawable.bg_item_pk_mover_more_percent_80);
            } else {
                llRoot.setBackgroundResource(R.drawable.bg_item_pk_mover_more_percent_90);
            }
            //累计数据
