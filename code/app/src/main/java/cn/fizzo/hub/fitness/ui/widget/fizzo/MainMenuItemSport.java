...
public class MainMenuItemSport extends ReflectItemView {

    private static final String TAG = "MainMenuItemSport";
    ...
    public MainMenuItemSport(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.layout_main_menu_item_sport, this, true);
     ...
     * 充实页面
     */
    public void updateView(final MainMenuItemSportME me) {
